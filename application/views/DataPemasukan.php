      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="DataPemasukanC"><i class="fa fa-circle-o"></i> Pemasukan Sekolah</a></li>
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo $as->pemberi; ?></td>
                        <td>
                            <!-- <?php echo anchor('DataPemasukanC/edit/'.$as->id_pemasukan,'<a class="btn btn-primary btn-xs">Edit</a>'); ?> -->
                            <a href="DataPemasukanC/edit/<?php echo $as->id_pemasukan ?>" class="btn btn-primary btn-xs">Edit</a> ||
                            <a href="DataPemasukanC/hapus/<?php echo $as->id_pemasukan ?>" class="btn btn-danger btn-xs">Hapus</a>
                            <!-- <?php echo anchor('DataPemasukanC/hapus/'.$as->id_pemasukan,'Hapus'); ?> -->
                        </td>
                      </tr>
                   <?php } ?>
                </tbody>
