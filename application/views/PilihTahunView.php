    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-calendar-minus-o"></i> <span>Pelaporan</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Pilih Tahun Pelaporan</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="PembukuanController/cariTahun" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputID3" class="col-sm-2 control-label">Tahun </label>
                  <div class="col-sm-10">
                    <input type="text" id="blnperiksa" name="tahun" class="datepicker-here form-control" data-language='en'
                        data-min-view="years" data-view="years" data-date-format="yyyy" placeholder="tahun" >
                  </div>
                </div>
              <!-- /.box-body -->
