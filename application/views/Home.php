      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="HomeController"><i class="fa fa-circle-o"></i> Pembayaran Siswa</a></li>
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td align=center>
                            <a href="HomeController/view_detail/<?php echo $as->id_pembayaran; ?>" class="btn btn-info btn-xs">VALIDATE</a>
                        </td>
                      </tr>
                   <?php } ?>
                </tbody>
