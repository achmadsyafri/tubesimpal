      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="DataPengeluaranC"><i class="fa fa-circle-o"></i> Pengeluaran</a></li>
          </ul>
        </li>
		<li class="treeview">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo $as->pengaju; ?></td>
                        <td>
                          <a href="DataPengeluaranC/edit/<?php echo $as->id_pengeluaran ?>" class="btn btn-primary btn-xs">Edit</a> ||
                          <a href="DataPengeluaranC/hapus/<?php echo $as->id_pengeluaran?>" class="btn btn-danger btn-xs">Hapus</a>
                        </td>
                      </tr>
                   <?php } ?>
                </tbody>
