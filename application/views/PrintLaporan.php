...
<body>
<h1></h1>
                        <h1 align="center">Laporan Bulanan Administrasi Keuangan</h1>
                         <br/>
                                ...
                                <p>
                                  ...
                                  <br/>
                                      <table border="1" width="100%" height="20%" style="border-collapse:collapse; table-layout:fixed;font-size:12px;">
                                        <tr align="center">
                                          <td width="5%">No.</td>
                                          <td style="word-wrap:break-word;" width="35%">Data</td>
                                          <td style="word-wrap:break-word;" width="65%">Jumlah</td>
                                        ...
                                        <tr align="center">
                                          ...
                                          <td style="word-wrap:break-word;" width="65%"><?php echo $pemasukanins+$pembayaranmhs;?></td>
                                        ...
                                        <tr align="center">
                                          ...
                                          <td><?php echo $pemasukanins+$pembayaranmhs-$pengeluaran;?></td>
                                        </tr>
                                      </table>
                                  <br/>
                              </tr>
