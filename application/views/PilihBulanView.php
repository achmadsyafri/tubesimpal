      ...
      <div class="row">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="Pelaporan_BulananC/cariTanggal" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputID3" class="col-sm-2 control-label">Bulan </label>
                  <div class="col-sm-10">
                    <input type="text" id="blnperiksa" name="tanggal" class="datepicker-here form-control" data-language='en'
