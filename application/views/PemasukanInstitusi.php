        ...
        <section class="col-lg-9 connectedSortable">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Form Input Pemasukan Sekolah</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="PemasukanController/insertPemasukan" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputID3" class="col-sm-2 control-label">ID Pemasukan</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="ID Pemasukan" name="idpemasukan">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="Oleh" name="pemberi">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
